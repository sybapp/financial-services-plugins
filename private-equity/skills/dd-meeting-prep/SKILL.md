...
description: "Prepare for due diligence meetings \u2014 management presentations,\
  \ expert network calls, customer references, and advisor sessions. Generates targeted\
  \ question lists, benchmarks to reference, and red flags to probe. Use before any\
  \ diligence meeting or call. Triggers on \"prep for management meeting\", \"diligence\
  \ call prep\", \"expert call questions\", \"customer reference questions\", or \"\
