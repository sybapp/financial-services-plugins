...
description: "Build and maintain a calendar of upcoming catalysts across a coverage\
  ...
  \ on \"catalyst calendar\", \"upcoming events\", \"what's coming up\", \"earnings\
  \ calendar\", \"event calendar\", or \"catalyst tracker\"."
---
...
- Earnings dates shift — verify against company IR pages, SEC filings, and free calendars (e.g., Yahoo Finance) closer to the date
